 ...
 */
  ...
  players[0].guest = false; // players[0].realId === '78439c31-beef-4f4d-afbb-e948e3d3c932'; 
  players[1].guest = false; // players[1].realId === '78439c31-beef-4f4d-afbb-e948e3d3c932'; 
...
async function savePG(players, matchId, matchInfo) {
  ...
  const player0_isGuest = false; // player0Id === '78439c31-beef-4f4d-afbb-e948e3d3c932'; // guest id attached // players[0].guest;
  const player1_isGuest = false; // player1Id === '78439c31-beef-4f4d-afbb-e948e3d3c932'; // guest id attached // players[1].guest;
